      ...
      <div className="container-bcr">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-12">
          ...
          <ScrollReveal delay={0.2}>
            <div className="space-y-4">
              {solutions.map((s, i) => (
                <div key={i} className="flex items-start gap-3 p-4 rounded-xl bg-white border border-primary/20 shadow-sm">
        ...
        <ScrollReveal delay={0.3}>
          <div className="max-w-3xl mx-auto p-8 rounded-2xl bg-white border border-primary/20 text-center shadow-sm">
